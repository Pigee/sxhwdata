...
api = Blueprint.group(liupanshanbp,wuzhongbp,changchengbp,hongsibaobp,ningdongbp,taiyangshanbp,tongxinbp,yanchibp,yinchuanbp,zhongningbp,zhongweibp,url_prefix="/api")
